<?php
    ...
    if ($_POST) {
        ...
        if ($error != "") {
            ...
            $emailTo = "info@bullyfirmuk.co.uk";
...
<head>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="contact-info">
            ...
            <div class="follow">
              <i class="fa fa-id-badge"></i> <a>Mr Nat Thakor</a>
            </div>

            <div class="follow">
              <i class="fa fa-phone"></i><a href="tel: +44 116 3323 475">+44 116 3323 475</a>
            </div>

            <div class="follow">
              <i class="fa fa-mobile"></i><a href="tel: +44 7746 679 350">+44 7746 679 350</a>
            </div>
            ...
            <!--<div class="follow">
              <i class="fa fa-instagram"></i>  <a href="https://www.instagram.com/bullyfirmuk/?hl=en">Social Media Link</a>
            </div>-->
    ...
    <section id="footer">
      ...
      <div class="socials">
        <a href="mailto: bullyfirmuk@gmail.com"><i class="fa fa-envelope"></i></a>
        <a href="tel: 07742471033"><i class="fa fa-phone"></i></a>
        <a href="https://www.instagram.com/bullyfirmuk/?hl=en"><i class="fa fa-instagram"></i></a>
        <a href="https://www.facebook.com/malik.heer.7"><i class="fa fa-facebook"></i></a>
      </div>
